...
export function init() {
  const containerElement = document.getElementById('three-container-morphingsphere')
  ...
  // loader.load('models/gltf/AnimatedMorphSphere/glTF/AnimatedMorphSphere.gltf'
  loader.load('/PrimaryIonDrive.gltf', function (gltf) {
    mesh = gltf.scene.getObjectByName('OSG_Scene')
    if (mesh) {
